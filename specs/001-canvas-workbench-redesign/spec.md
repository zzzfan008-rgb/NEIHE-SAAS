...
用户可以在“视频制作”分组中了解文生视频、首尾帧生视频、多图参考生视频和视频生视频四种
...
1. **Given** 四种视频能力均未上线，**When** 用户打开视频分组，**Then** 四个项目完整显示且明确
   标记不可用，不创建节点或请求。
...
- **FR-003**: “服装设计” MUST 包含草图到效果图、AI 改款、面料替换、配色替换、印花提取、印花裂变。
- **FR-004**: “模特换装” MUST 包含白底图制作、一键换装、风格迁移；双模型分步换装 MUST 作为
  一键换装的高级模式提供，而不是新增第六个一级分组。
- **FR-005**: “视频制作” MUST 包含文生视频、首尾帧生视频、多图参考生视频、视频生视频。
